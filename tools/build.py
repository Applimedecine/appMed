...
LESSONS = [
    ...
    {"slug": "fc07", "code": "FC07", "order": 8, "prof": "Pr. Lefebvre",
    ...
    {"slug": "fc08", "code": "FC08", "order": 9, "prof": "Pr. Lefèvre",
    ...
    {"slug": "fc15", "code": "FC15", "order": 16, "prof": "Pr. Mariat",
     "title": "Mécanismes de rejet de greffe",
    ...
    {"slug": "fc17", "code": "FC17", "order": 18, "prof": "Dr. Waeckel",
     "title": "Anticorps thérapeutiques et protéines de fusion",
    ...
    {"slug": "fc18", "code": "FC18", "order": 19, "prof": "Pr. Stephan",
     "title": "Introduction à l’étude des déficits immunitaires héréditaires",
    ...
    {"slug": "fc21", "code": "FC21", "order": 22, "prof": "Pr. Killian",
     "title": "Lupus érythémateux systémique",
     "shortTitle": "Lupus (LES)",
     "file": "FC21-KILLIAN-Lupus-06-03-26(2).pdf"},
    {"slug": "fc22", "code": "FC22", "order": 23, "prof": "Pr. Hean",
...
def _resolve_path(base, filename):
    """Try NFC then NFD normalization to handle filesystem Unicode variants."""
    for form in ("NFC", "NFD"):
        p = os.path.join(base, unicodedata.normalize(form, filename))
        if os.path.exists(p):
            return p
...
def build_cours(lesson, report=False):
    ...
    if os.path.exists(out_existing):
        try:
            ...
            pass
    path = _resolve_path(ROOT, lesson["file"])
